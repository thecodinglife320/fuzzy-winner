...
fun ItemDetailsScreen(
    ...
    val detailsUiState by viewModel.detailsUiStateFlow.collectAsState()
    ...
    Scaffold(
        topBar = {
            ...
            FloatingActionButton(
                onClick = { navigateToEditItem(detailsUiState.itemDetails.id) },
        ...
        ItemDetailsBody(
            itemDetailsUiState = detailsUiState,
